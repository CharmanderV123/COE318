...
//TODO Add instance variables (Hint: you only need 2!)
    private double resistor_value_v = 0;
    private double current_value_v = 0;
    private double voltage_value_v = 0; 
...
return current_value_v*resistor_value_v;
}
/**
...
return voltage_value_v/resistor_value_v;
}
/**
...
//FIX THIS
return ((voltage_value_v*voltage_value_v)/resistor_value_v);
}
/**
